...
public abstract class TypeAdapter extends BaseAdapter
{
     ...
     * @return view
     */
    protected <V extends View> V view( final View parentView, final int childViewIndex )
    {
     ...
     * @return text view
     */
    protected TextView setText( final View parentView,
     ...
     * <p>
     * This method uses the formatter returned from {@link NumberFormat#getIntegerInstance()}
     * 
     * @param childViewIndex
     * @param number
     * @return text view
     ...
     * @return text view
     */
    protected TextView setNumber( final View parentView, final int childViewIndex, final long number )
    {
     ...
     * @return child view
     */
    protected <T> T getView( final int childViewIndex, final Class<T> childViewClass )
    {
     ...
     * @return child view
     */
    protected <T> T getView( final View parentView,
                             final int childViewIndex,
     ...
     * @return child view
     */
    protected View setGone( final View parentView, final int childViewIndex, boolean gone )
    {
     ...
     * @return check box
     */
    protected CompoundButton setChecked( final int childViewIndex, final boolean checked )
    {
     ...
     * @return text view
     */
    public TextView setVisibleText( final int childViewIndex, final CharSequence text )
    {
