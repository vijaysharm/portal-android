...
public class ViewUpdater
{
     ...
     */
    @SuppressWarnings("unchecked")
    public <V extends View> V view( final View parentView, final int childViewIndex )
    {
     ...
     * @return text view
     */
    public TextView setText( final View parentView,
     ...
     * @return text view
     */
    public TextView setText( final View parentView, final int childViewIndex, final int resourceId )
    {
        final TextView textView = textView( parentView, childViewIndex );
        textView.setText( resourceId );
        return textView;
     ...
     * @return text view
     */
    public TextView setNumber( final View parentView, final int childViewIndex, final long number )
    {
        final TextView textView = textView( parentView, childViewIndex );
        textView.setText( FORMAT_INT.format( number ) );
        return textView;
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T getView( final int childViewIndex, final Class<T> childViewClass )
    {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T getView( final View parentView,
                          final int childViewIndex,
     ...
     * @return child view
     */
    public View setGone( final View parentView, final int childViewIndex, boolean gone )
    {
